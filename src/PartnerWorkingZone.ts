...
export class PartnerWorking_ZoneEntity implements PartnerWorking_Zone {
  constructor(public zone: ZoneEntity, public price: number) {}
}
...
{
  constructor(public community: Community, public price: number) {}
}
...
export class NewPartnerWorking_CommunityEntity
  implements NewPartnerWorking_Community
{
  constructor(
    public partnerId: number,
...
export class PartnerWorking_CityEntity implements PartnerWorking_City {
  constructor(public city: City, public price: number) {}
}
...
export interface PartnerWorking_Region {
  city: City;
  price: number;
}

export declare class PartnerWorking_RegionEntity
  implements PartnerWorking_Region
{
  city: City;
  price: number;
